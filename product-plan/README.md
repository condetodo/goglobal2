# Go Global Dubbing Manager — Design Handoff

This folder contains everything needed to implement Go Global Dubbing Manager.
...
2. Start with Foundation (`instructions/incremental/01-foundation.md`) — includes design tokens, data model, and routing
3. For each section:
